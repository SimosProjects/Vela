...
public class PeriodicReconciliationService : BackgroundService
{
        ...
        CancellationToken ct)
    {
        ...
        foreach (var trade in openTrades)
        {
            ...
            await _discord.NotifyCriticalAsync(
                ...
                "TradeFlow but not found in IBKR. It may have closed without TradeFlow detecting " +
        ...
        CancellationToken ct)
    {
        ...
        foreach (var ibkrPos in longPositions)
        {
            ...
            var message = $"Position in **{ibkrPos.Symbol}** " +
                ...
                "is not managed by TradeFlow. Tracking as MANUAL — " +
    ...
    // The user closed them via IBKR — TradeFlow removes the dashboard entry and notes the closure.
