...
Two analytics systems run against the Vela PostgreSQL database. Neither reads from the CSV files, both query `trade_metrics` directly, so they are independent of the CSV archive cycle.
