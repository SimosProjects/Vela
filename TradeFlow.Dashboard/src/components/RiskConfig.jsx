...
/// RiskConfig panel. blockHigh and blockLotto are live session toggle states — when
/// the toggle is OFF (allowed), the Allow flag shows green ON; when ON (blocked), red OFF.
export function RiskConfig({ config, blockHigh = true, blockLotto = true }) {
  return (
    <Card>
